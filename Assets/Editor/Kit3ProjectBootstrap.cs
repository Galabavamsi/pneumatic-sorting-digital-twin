...
{
    [InitializeOnLoad]
    public static class Kit3ProjectBootstrap
    {
        ...
        private const string MaterialPath = "Assets/Materials/Kit3Metal.mat";
        private const string SessionKey = "DigitalTwin.Kit3BootstrapAttempted";

        static Kit3ProjectBootstrap()
        {
        ...
        [MenuItem("Digital Twin/Build Kit 3 Viewer")]
        public static void Run()
        {
            ...
            if (modelAsset == null)
            {
                throw new FileNotFoundException("Unity could not import the Kit 3 OBJ.", ModelPath);
            }

            GameObject stationRoot = new GameObject("Kit3_AssemblyStation");
            GameObject modelInstance = (GameObject)PrefabUtility.InstantiatePrefab(modelAsset);
            modelInstance.name = "Components_69";
            ...
            Transform target = CreateCameraTarget(modelBounds);
            CreateCamera(modelBounds, target);
            CreateLighting();
            CreateInstructions();
            ...
            Debug.Log("KIT3_BOOTSTRAP_COMPLETE: viewer scene and 69-component prefab created.");
        }
        ...
        private static void ConfigureModelImporter()
        {
            ...
            if (importer == null)
            {
                throw new FileNotFoundException("No ModelImporter was created for Kit 3.", ModelPath);
            }
        ...
        private static Bounds CalculateBounds(Renderer[] renderers)
        {
            ...
            {
                throw new MissingComponentException("Kit 3 has no renderable mesh components.");
            }
        ...
        private static void CreateCamera(Bounds modelBounds, Transform target)
        {
            ...
            cameraObject.transform.position = target.position +
                new Vector3(distance, distance * 0.72f, -distance);
        ...
        private static void CreateInstructions()
        {
            ...
            panelRect.sizeDelta = new Vector2(540f, 116f);
        ...
        private static Material GetOrCreateMaterial()
        {
            ...
            material.SetColor("_BaseColor", new Color(0.48f, 0.62f, 0.72f));
